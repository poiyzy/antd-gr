...
var AntMenu = _react2['default'].createClass({
  ...
  render: function render() {
    ...
    var children = this.props.children.filter(function (item) {
      return !!item;
    });
    if (this.props.mode === 'inline') {
      return _react2['default'].createElement(_rcMenu2['default'], _extends({}, this.props, { className: className, openAnimation: openAnimation, children: children }));
    } else {
      return _react2['default'].createElement(_rcMenu2['default'], _extends({}, this.props, props, { className: className, openTransitionName: openAnimation, children: children }));
    }
  }
});
